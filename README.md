...
資料は `Documents/2026_07_27_マイコンC言語基礎講座.pdf`（全122枚）です。
...
| 第4部 | 76–87 | Keyboard Practice 1 / 2 | コメント `//`・**`switch` 文**・`break` |
| 第5部 | 88–101 | Snake Solver | **二次元配列**・**BFS**・参照渡し `&` |
| 第6部 | 102–117 | Snake VS（CPU 5段ラダー） | **ボロノイ**・ミニマックス・RAM の節約 |
| — | 118–122 | 残り時間の挑戦／アフターフォロー | — |
